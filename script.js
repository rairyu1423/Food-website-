...
gsap.fromTo("#galleryCard .ca1",
  {opacity:0,scale:0.8,},
  {opacity:1,duration:0.4,scale:1,
    scrollTrigger:{
      // trigger:"#galleryCard",
